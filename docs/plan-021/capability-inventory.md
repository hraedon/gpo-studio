...
| GPO import (from backup) | supported (GPMC backup import; native v2 `Backup.xml` certified by Plan 033 WP-2 on WS2025) | verified (raw registry) | [Import-GPO](https://learn.microsoft.com/en-us/powershell/module/grouppolicy/import-gpo) | Plan 033 WP-2 (certified run `wp2-native-import-20260803230132-8090`) |
...
| GPO backup | supported subset (GPMC backup export; native v2 `Backup.xml` writer certified by Plan 033 WP-2; GPP writer conformance certified by WP-1B for Drives, Local Users and Groups, Scheduled Tasks daily Exec, Services) | verified (raw registry + named GPP families) | [Backup-GPO](https://learn.microsoft.com/en-us/powershell/module/grouppolicy/backup-gpo) | Plan 033 WP-2 / WP-1B |
