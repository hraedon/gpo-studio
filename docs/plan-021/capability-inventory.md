...
| GPO import (from backup) | supported (GPMC backup import; native v2 `Backup.xml` certified by Plan 033 WP-2 on WS2025) | verified (raw registry) | [Import-GPO](https://learn.microsoft.com/en-us/powershell/module/grouppolicy/import-gpo) | Plan 033 WP-2 (certified run `wp2-native-import-20260726235913-9111`) |
